...
<img src="/imagess/wiki/Redis/Redis_Hashmap.jpg" width="700" alt="Redis数据结构">
...
<img src="/imagess/wiki/Redis/Redis_Cluster.jpg" width="700" alt="Redis集群">

集群中的节点可以通过Master-Slaver模式实现高可用（一台宕机，其余可工作）和查询速率提升（Master可交任务给Slaver处理）：

<img src="/imagess/wiki/Redis/Redis_Cluster_Master_Slaver.jpg" width="700" alt="Redis的Master和Slaver模式">
...
<img src="/imagess/wiki/Redis/sub.png" width="700" alt="订阅">

<img src="/imagess/wiki/Redis/pub.png" width="700" alt="发布">
